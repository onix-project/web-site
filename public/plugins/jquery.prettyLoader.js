...
(function($) {
	...
	$.prettyLoader = function(settings) {
		settings = jQuery.extend({
			...
			loader: 'images/prettyLoader/ajaxloader.gif', /* Path to your loader gif */
		...
		imgLoader.onerror = function(){
			alert('Imagen de preloader no se puede cargar. Asegurese de que la ruta en la configuracion es correcta.');
		};
		...
		$.prettyLoader.show = function(delay){
			...
			if(delay) setTimeout(function(){ $.prettyLoader.hide() }, delay);
